...
const rules: string[] = [
  ...
  "تو میتونی متنی که بهت مبدن رو ویرایش کنی یا کم و زیاد کنی بر اساس دستوری که کاربر میده اگر بخواد و اگر چیزی نیاز نداشت کاری نمیکنی ازش میپرسی باید چیکار کنی",
